...
<div class="wp-block-group" style="padding-top:0;padding-right:var(--wp--preset--spacing--50);padding-bottom:0;padding-left:var(--wp--preset--spacing--50)">
	<!-- wp:post-featured-image {"align":"full","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|50"}}}} /-->
	...
	<div class="wp-block-group has-primary-color has-text-color has-questrial-font-family has-xsmall-font-size" style="margin-top:var(--wp--preset--spacing--50);margin-bottom:var(--wp--preset--spacing--50);padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
	...
	<main class="wp-block-group has-medium-font-size" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--40);padding-right:0;padding-left:0">
		...
		<div class="wp-block-comments wp-block-comments-query-loop">
			...
			<div class="wp-block-columns">
				...
				<div class="wp-block-column">
					...
					<div class="wp-block-group has-normal-font-size" style="margin-top:0px;margin-bottom:0px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
						<!-- wp:comment-date {"style":{"typography":{"fontStyle":"normal","fontWeight":"300"}},"fontSize":"normal"} /-->

						<!-- wp:comment-edit-link {"style":{"typography":{"fontStyle":"normal","fontWeight":"300"}},"fontSize":"normal"} /-->
					</div>
					<!-- /wp:group -->

					<!-- wp:comment-content {"style":{"typography":{"fontStyle":"normal","fontWeight":"300"}},"fontSize":"normal"} /-->

					<!-- wp:comment-reply-link {"textAlign":"left","style":{"typography":{"fontStyle":"normal","fontWeight":"300"}},"fontSize":"normal"} /-->
				</div>
				<!-- /wp:column -->
			</div>
			<!-- /wp:columns -->
		...
		<!-- wp:post-comments-form {"style":{"typography":{"fontStyle":"normal","fontWeight":"300"}},"fontSize":"normal"} /-->
	</main>
	<!-- /wp:group -->
</div>
<!-- /wp:group -->
